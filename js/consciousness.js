...
addLayer("cb", {
	...
	resetsNothing() {return player.w.unlocked},
	autoPrestige() {return player.w.unlocked},
	tabFormat() {
		...
		if (player.cb.focusUnlocked) {
			...
			if (maximum > 0) {
				...
				svg += "<rect x='" + (500 - right) + "' y='0' width='" + right + "' height='50' fill='#B44990'/>";
