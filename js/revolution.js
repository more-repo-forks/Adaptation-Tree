...
addLayer("r", {
	...
	milestones: {
		...
		76: {
			...
			popupTitle: "Innovation Acquired!",
			effectDescription() {return "reduce the requirement scaling of cyclical generators<br>Req: " + formatWhole(this.requirement) + " change"},
			done() {return player.r.change.gte(this.requirement)},
			unlocked() {return hasMilestone("r", this.id - 1)},
		},
		77: {
		...
		83: {
			...
			onComplete() {player.ex.buyables[22] = new Decimal(0)},
			unlocked() {return hasMilestone("r", this.id - 1)},
		},
		84: {
			requirement: "1e2500",
