...
addLayer("r", {
	...
	milestones: {
		...
		67: {
			...
			popupTitle: "Innovation Acquired!",
			effectDescription() {return "improve last settler effect<br>Req: " + formatWhole(this.requirement) + " change"},
			done() {return player.r.change.gte(this.requirement)},
			unlocked() {return hasMilestone("r", this.id - 1)},
		},
		68: {
		...
		71: {
			...
			popupTitle: "Innovation Acquired!",
			effectDescription() {return "improve first settler effect<br>Req: " + formatWhole(this.requirement) + " change"},
			done() {return player.r.change.gte(this.requirement)},
			unlocked() {return hasMilestone("r", this.id - 1)},
		},
		72: {
