...
addLayer("em", {
	...
	effect() {
		...
		let eff = [
			...
			(hasMilestone("em", 28) && player.em.points.gte(8) ? (getClickableState("em", 22) || 0) / 10 : new Decimal(1)),
			(hasMilestone("em", 28) && player.em.points.gte(8) ? new Decimal(1000).pow(getClickableState("em", 22) || 0) : new Decimal(1)),
			thirdSectorEff,
		];
