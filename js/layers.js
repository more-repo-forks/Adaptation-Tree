...
addLayer("e", {
	...
	tabFormat: [
		...
		["display-text", () => {
			...
			if (player.e.points.gte(13)) text += "<br><br>After you evolve fourteen times, the last evolution effect is multiplied by 500";
			return text;
		}],
		"blank",
		"challenges",
