...
var displayThings = [
	...
	() => {return "<br>current endgame is 1,591 " + (player.e.unlocked ? "evolutions" : "???") + " and 193 " + (player.a.unlocked ? "acclimation points" : "???")},
];

// Determines when the game "ends"
function isEndgame() {
	return player.e.points.gte(1591) && player.a.points.gte(193);
};
